...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'tokenAllowRead' => \App\Http\Middleware\tokenAllowRead::class,
        'tokenAllowWrite' => \App\Http\Middleware\tokenAllowWrite::class,
        'tokenAllowEdit' => \App\Http\Middleware\tokenAllowEdit::class,
        'tokenAllowRemove' => \App\Http\Middleware\tokenAllowRemove::class,
        ...
        // 'g-recaptcha' =>\App\Http\Middleware\GoogleRecapchaV3::class,
